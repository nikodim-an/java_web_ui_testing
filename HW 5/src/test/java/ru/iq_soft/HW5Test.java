 ...
 * @project : HW_5
 * @date : 24.02.2022
 * @comments : Реализация 4-х тестов из домашней работы №3 в JUnit «как есть», без использования класса Actions…
 *             и дополнительно 2-х тестов, на которые расширилось задание
